...
interface CounterProps {
    ...
    className?: string;
    inputClass?: string;
    calculateHandler?: any;
}

const Counter: React.FC<CounterProps> = ({ initialValue = 0, decrementClass, incrementClass, className, inputClass, calculateHandler }) => {
