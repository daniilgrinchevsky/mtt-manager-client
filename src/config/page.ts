...
class PAGE implements Enum {
    ...
    static readonly TOURNEYS = new PAGE('/tourneys', 'Турниры')
    static readonly SESSION = new PAGE('/session', 'Сессия')
    static readonly ANALYTICS = new PAGE('/analytics', 'Аналитика')
